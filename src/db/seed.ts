...
export async function seedDatabase(): Promise<void> {
  ...
  // 10. Lessons Progress & Curriculum Map
  const lessonsList: Array<Omit<ClassLesson, "id">> = [
    {
      classId: class1Id,
      lessonNumber: 1,
      unitOrTopic: "Unit 1: Introductions & Basics",
      title: "Arabic Alphabet & Emphatic Sounds",
      lessonDate: "2026-09-07",
      status: "completed",
      assignmentTitle: "Alphabet tracing sheet & vocal exercises (Q1–10)",
      assignmentDueDate: "2026-09-09",
      assignmentNotes: "Focus on proper stroke order for letters Seen, Saad, Taa, and Dhad.",
      learningObjectives: "Accurately recognize and pronounce the 28 Arabic letters and emphatic sounds.",
      notes: "Class engaged enthusiastically with phonetic drills. Adam needed slight guidance on letter connection rules.",
      orderIndex: 1,
      createdAt: isoNow,
      updatedAt: isoNow,
    },
    {
      ...
      lessonNumber: 2,
      unitOrTopic: "Unit 1: Introductions & Basics",
      title: "Short & Long Vowels (Harakat and Madd)",
      lessonDate: "2026-09-09",
      status: "completed",
      assignmentTitle: "Workbook Page 8: Vowel length audio drill",
      assignmentDueDate: "2026-09-14",
      assignmentNotes: "Complete exercises A & B and listen to the audio track on portal.",
      learningObjectives: "Differentiate between short Fatha/Damma/Kasra and long Alif/Waw/Yaa.",
      notes: "Pronunciation tests showed 90%+ accuracy across the cohort.",
      orderIndex: 2,
      createdAt: isoNow,
      updatedAt: isoNow,
    },
    {
      classId: class1Id,
      lessonNumber: 3,
      unitOrTopic: "Unit 2: Family & Home",
      title: "Immediate Family Vocabulary & Possessive Pronouns",
      lessonDate: "2026-09-10",
      status: "completed",
      assignmentTitle: "Family Tree Mini-Poster & 5 Sentences",
      assignmentDueDate: "2026-09-16",
      assignmentNotes: "Draw a family tree and write sentences using 'My father is...', 'My sister is...'",
      learningObjectives: "Use possessive suffixes (-i, -ka, -ki, -hu, -haa) with family nouns.",
      notes: "Zayd and Fatima gave outstanding live demonstrations of the dialogue.",
      orderIndex: 3,
      createdAt: isoNow,
      updatedAt: isoNow,
    },
    {
      ...
      lessonNumber: 4,
      unitOrTopic: "Unit 2: Family & Home",
      title: "Describing Physical Appearance & Personality Adjectives",
      lessonDate: "2026-09-14",
      status: "in_progress",
      assignmentTitle: "Textbook page 22 reading comprehension Q1–5",
      assignmentDueDate: "2026-09-17",
      assignmentNotes: "Answer questions in full Arabic sentences.",
      learningObjectives: "Apply feminine/masculine adjective agreement rules in descriptive paragraphs.",
      notes: "Working through gender agreement rules in pairs.",
      orderIndex: 4,
      createdAt: isoNow,
      updatedAt: isoNow,
    },
    {
      classId: class1Id,
      lessonNumber: 5,
      unitOrTopic: "Unit 3: School Life & Routine",
      title: "School Subjects, Timetables, and Expressing Opinions",
      lessonDate: "2026-09-16",
      status: "planned",
      assignmentTitle: "Draft a paragraph: 'My Favorite School Day'",
      assignmentDueDate: "2026-09-21",
      assignmentNotes: "Include at least 3 reasons why using 'li'anna' (because).",
      learningObjectives: "Express likes, dislikes, and justifications regarding school subjects.",
      orderIndex: 5,
      createdAt: isoNow,
      updatedAt: isoNow,
    },
    {
      ...
      lessonNumber: 6,
      unitOrTopic: "Unit 3: School Life & Routine",
      title: "Telling the Time & Daily Routine Verbs",
      lessonDate: "2026-09-17",
      status: "planned",
      assignmentTitle: "Daily schedule timeline table in Arabic",
      assignmentDueDate: "2026-09-23",
      assignmentNotes: "List 6 daily activities with exact clock times.",
      learningObjectives: "Tell time on the hour, half past, and quarter past with present tense verbs.",
      orderIndex: 6,
      createdAt: isoNow,
      updatedAt: isoNow,
    },
  ];
  await db.lessons.bulkAdd(lessonsList as ClassLesson[]);
